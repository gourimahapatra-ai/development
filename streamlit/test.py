...
IN_flag = Image.open(r"C:\Development\pythonDevelopment\Streamlit\StreamlitExample\UsersHPDesktopdataappIN.jpg")
col1.header("INDIA")
col1.image(IN_flag, use_column_width=True)
US_flag = Image.open(r"C:\Development\pythonDevelopment\Streamlit\StreamlitExample\UsersHPDesktopdataappUS.JPG")
col2.header("USA")
